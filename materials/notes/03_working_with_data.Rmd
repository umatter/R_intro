...
This framework got implemented in *R* with the very prominent `ggplot2`-package, building on the already very powerful *R* graphics engine. The result is a user-friendly environment to visualize data with *R* with enormous potential to plot almost any graphic illustrating data.
